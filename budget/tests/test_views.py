...
class TestViews(TestCase):
    ...
    def test_project_detail_POST_adds_new_expense(self):
        ...
        response = self.client.post(self.detail_url, {'title':'expense1', 'amount':'1000', 'category':'dev'})
    ...
    def test_project_detail_DELETE_deletes_expense(self):
        category1 = Category.objects.create(project = self.project1, name = 'dev')
    ...
    def test_project_create_POST(self):
        ...
        self.assertEquals(second_category.name, 'dev')
